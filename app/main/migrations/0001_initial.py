    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related', models.ManyToManyField(blank=True, to='main.post')),
        ...
        migrations.AddConstraint(
            model_name='comment',
            constraint=models.CheckConstraint(check=models.Q(('post__isnull', False), ('parent__isnull', False), _connector='OR'), name='not_all_null'),
        ),
    ]
